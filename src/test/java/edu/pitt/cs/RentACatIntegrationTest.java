...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		// TODO: Fill in
		r = RentACat.createInstance(InstanceType.IMPL); // Use real implementation
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		assertEquals("listCats should return an empty string when no cats are present", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("listCats should correctly list all non-rented cats", expectedOutput, r.listCats());
	}
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		assertFalse("renameCat should return false when there is no cat", r.renameCat(2, "Garfield"));
		assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testRenameNumCat3() {
		...
		assertTrue("renameCat should return true when the cat exists", r.renameCat(2, "Garfield"));
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("rentCat should return true when the cat is available", r.rentCat(2));
